      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            Remote Fullstack Developer specializing in PHP
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          Remote Full Stack Developer with a strong foundation in relational databases, system administration, and Dev Ops
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/pjkellar"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://instagram.com/patrickkellar"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/pjkellar"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/patrickjameskellar"
